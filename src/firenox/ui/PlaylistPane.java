...
public class PlaylistPane extends BorderPane{
    ...
    public PlaylistPane() {
        PagedList<PlayList> favList = ModelManager.getMyPlaylists();
    ...
    private TilePane buildTileView(PagedList<PlayList> playLists) {
        ...
        playLists.setNewEntriesLoadedListener(() ->
                playLists.getLastLoadedEntries().forEach(playList ->
                        tilePane.getChildren().add(UIUtils.buildPlayListTile(playList, width, heigth))));
        return tilePane;
    }
}
