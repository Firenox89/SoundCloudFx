...
//    }
  ...
  public void toggleLike() {
    ...
    if (iLike == 1) {
      ...
      log.log(LogType.NETWORK, "Unlike track " + this);
      iLike = 0;
      ModelManager.getMe().getLikes().remove(this);
    } else {
      RequestManager.likeTrack(id);
      log.log(LogType.NETWORK, "Like track " + this);
      iLike = 1;
  ...
  public String getStreamURL() {
    ...
    try {
      ...
      log.log(LogType.NETWORK, "streamable = " + streamable);
      log.log(LogType.NETWORK, "stream_url = " + stream_url);
  ...
  public User getUser() {
    if (user == null) {
      user = ModelManager.getUser(userId);
    }
    return user;
  }
