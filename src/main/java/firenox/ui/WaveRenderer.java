...
public class WaveRenderer {
  ...
  private final static javafx.scene.paint.Color unplayed1 = javafx.scene.paint.Color.LIGHTGREY;
  private final static javafx.scene.paint.Color unplayed2 = javafx.scene.paint.Color.GREY;
  private final static javafx.scene.paint.Color played1 = javafx.scene.paint.Color.web("#ff8800");
  private final static javafx.scene.paint.Color played2 = javafx.scene.paint.Color.web("#995200");
